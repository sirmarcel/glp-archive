...
from tbx.gk_plot import plot_cutoff
...
reference = load(results / "snse_kappa/reference.npz")


table = []
for L in [1, 2, 3]:
    data = load(results / f"snse_kappa/sokrates_L{L}_prod.nc")
...
print(table_to_string(table, colsep=",", width=20))
...
savetab(tab, tables / "snse_kappa.tex")
